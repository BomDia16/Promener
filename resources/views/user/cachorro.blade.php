...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>Promener - Cachorros</title>
    ...
    <body class="antialiased">
        ...
        <div class="container">
            <div class="row" style="display: flex;">
                        ...
                        <div class="">
                            <div class="card content">
                                ...
                                <div class="card-action">
                                    <p>Adicionar o seu cachorro!</p>
                                    <a href="{{ route('cachorro.create') }}">Adicionar<i class="material-icons">add</i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-2 mb-2" style="padding-left: 10px;">
                    <div class="row">
                        <div class="">
                            <div class="card content">
                                <div class="card-image">
                                    <img src="{{ $cachorro->imagem }}" class="img-produto">
                                </div>
                                
                                <div class="card-content">
                                    <span class="card-title">{{ $cachorro->nome }}</span>
                                    <p>Informações adicionais: {{ $cachorro->informacao_extra }}</p>
                                </div>
                                <div class="card-action">
                                    <p>Peso: R${{ $cachorro->peso }}</p>
                                    <a href="cachorro/{{ $cachorro->id }}">Passear</a>
                                </div>
                            </div>
                        </div>
                    </div>
