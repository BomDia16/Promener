...
<html lang="pt-br">
    <head>
        ...
        <!-- Title / Icon -->
        <title>Promener - Login passeador</title>
    ...
    <body class="antialiased">  
        ...
        <div class="grey lighten-2 login container justify-center">
            ...
            <h3>Login passeador</h3>
            <!-- Form -->
            <div class="row">
                <form method="POST" action="{{ route('passeador.login') }}" class="col s12">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col s7">
                            Não possui uma conta? <a href="{{ route('passeador.register') }}">crie uma</a>
                        </div>
                        <div class="col s2"></div>
                    </div>
                </form>
